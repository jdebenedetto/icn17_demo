...
#include "icnet_ccnx_pending_anp_interest.h" //SAID
...
typedef std::unordered_map<Name, std::unique_ptr<PendingANPInterest>> PendingANPInterestHashTable; //SAID
...
class Portal : public std::enable_shared_from_this<Portal> // : public api::Face
{
 ...
 private:
  ...
  PendingANPInterestHashTable pending_anp_interest_hash_table_; //SAID
