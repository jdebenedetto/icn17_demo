...
#ifndef ICNET_CCNX_PENDING_ANP_INTEREST_H_
#define ICNET_CCNX_PENDING_ANP_INTEREST_H_
...
class PendingANPInterest {
 public:

  friend class Portal;

  PendingANPInterest(std::shared_ptr<Interest> &interest,
...
#endif // ICNET_CCNX_ANP_PENDING_INTEREST_H_
