...
class HTTPClientConnectionSaid {
 public:
  HTTPClientConnectionSaid();

  HTTPClientConnectionSaid &get(std::string &url, HTTPHeaders headers = {}, HTTPPayload payload = {});

  HTTPResponse &&response();

  HTTPClientConnectionSaid &stop();
