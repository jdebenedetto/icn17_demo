...
//------------------------SAID--------------------------------------------------------
/**
 * @function metisNumberSet_Inc
 * @abstract Increment the count associated to the MetisNumber given in input
 * @discussion
 *
 * @param <#param1#>
 * @return true if added, false if a duplicate
 */
 bool metisNumberSet_IncCount(MetisNumberSet *set, MetisNumber number);

/**
 * @function metisNumberSet_Dec
 * @abstract Decrement the count associated to the MetisNumber given in input
 * @discussion
 *
 * @param <#param1#>
 * @return true if added, false if a duplicate
 */
 bool metisNumberSet_DecCount(MetisNumberSet *set, MetisNumber number);

 /**
 * @function metisNumberSet_DecAllCounts
 * @abstract Decrement all the counters in the set
 * @discussion
 *
 * @param <#param1#>
 */
 void metisNumberSet_DecAllCounts(MetisNumberSet *set);

 /**
 * @function metisNumberSet_UpdateMax
 * @abstract Decrement the count associated to the MetisNumber given in input
 * @discussion
 *
 * @param <#param1#>
 * @return true if added, false if a duplicate
 */
 bool metisNumberSet_UpdateMax(MetisNumberSet *set, MetisNumber count);
 ...
 * @return true if added, false if a duplicate
 */
 bool metisNumberSet_DecMax(MetisNumberSet *set);
//------------------------SAID--------------------------------------------------------
...
//----------------------------SAID-------------------------------------------------
/**
 * @function metisNumberSet_IndexOf
 * @abstract Get the index of the specified number in the set
 * @discussion
 *   <#Discussion#>
 *
 * @param <#param1#>
 * @return the index of the number in the set , -1 if not present
 */
 int metisNumberSet_IndexOf(const MetisNumberSet *set, MetisNumber number);
 //----------------------------SAID-------------------------------------------------
