...
{
    // printf("metisHashTableFunction_MessageNameEquals\n"); //DEBUG
    const MetisMessage *a = (const MetisMessage  *) keyA;
    const MetisMessage *b = (const MetisMessage  *) keyB;

    // //------------------------------SAID-------------------------------------------
    // uint8_t flagA = metisMessage_GetFlags(a);
    // uint8_t flagB = metisMessage_GetFlags(b);
    // if(flagA == 1 && flagB == 1) {
    //     // printf("ANP interest\n"); //DEBUG
    //     // return metisTlvName_Equals(metisMessage_GetANPName(a), metisMessage_GetANPName(b));
    //     MetisTlvName* ANPNameA = metisMessage_GetANPName(a);
    //     MetisTlvName* ANPNameB = metisMessage_GetANPName(b);
    //     bool equals = metisTlvName_Equals(ANPNameA, ANPNameB);
    //     metisTlvName_Release(&ANPNameA);
    //     metisTlvName_Release(&ANPNameB);
    //     return equals;
    // }
...
//----------------------------------SAID---------------------------------------------
bool
metisHashTableFunction_MessageNameANPEquals(const void *keyA, const void *keyB)
{
    // printf("metisHashTableFunction_MessageNameEquals\n"); //DEBUG
    const MetisMessage *a = (const MetisMessage  *) keyA;
    const MetisMessage *b = (const MetisMessage  *) keyB;
...
HashCodeType
metisHashTableFunction_MessageNameANPHashCode(const void *keyA)
{
    const MetisMessage *message = (const MetisMessage *) keyA;
    
    MetisTlvName* ANPName = metisMessage_GetANPName(message);
    uint32_t hash = metisTlvName_HashCode(ANPName);
    metisTlvName_Release(&ANPName);        
...
{
    // printf("metisHashTableFunction_MessageNameAndKeyIdEquals\n"); //DEBUG
...
{ 
    // printf("metisHashTableFunction_MessageNameAndObjectHashEquals\n"); //DEBUG    
