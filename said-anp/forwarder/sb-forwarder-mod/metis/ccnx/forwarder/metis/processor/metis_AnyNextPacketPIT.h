...
/**
 * @file metis_AnyNextPacketPIT.h
 * @brief The Pending Interest Table
 *
 * Implements the AnyNextPacket Pending Interest Table.
 *
 */

#ifndef Metis_metis_AnyNextPacketPIT_h
#define Metis_metis_AnyNextPacketPIT_h
 ...
 * @endcode
 */
MetisPIT *metisAnyNextPacketPIT_Create(MetisForwarder *metis);
