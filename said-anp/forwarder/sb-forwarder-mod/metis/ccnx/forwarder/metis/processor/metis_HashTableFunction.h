...
//------------------------------------SAID---------------------------------------------------------------
bool metisHashTableFunction_MessageNameANPEquals(const void *metisMessageA, const void *metisMessageB);

HashCodeType metisHashTableFunction_MessageNameANPHashCode(const void *metisMessageA);
//-----------------------------------SAID--------------------------------------------------------------------
