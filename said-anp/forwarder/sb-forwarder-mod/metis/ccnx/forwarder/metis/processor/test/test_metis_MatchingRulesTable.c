...
LONGBOW_TEST_CASE(Global, metisMatchingRulesTable_GetUnion_1Table)
{
    ...
    printf("metisMatchingRulesTable_GetUnion_1Table\n");
    ...
    MetisMessage *interestByName = metisMessage_CreateFromArray(metisTestDataV1_Interest_NameA_Crc32c, sizeof(metisTestDataV1_Interest_NameA_Crc32c), 1, 2, logger);
    ...
    MetisMessage *object = metisMessage_CreateFromArray(metisTestDataV1_ContentObject_NameA_Crc32c, sizeof(metisTestDataV1_ContentObject_NameA_Crc32c), 1, 4, logger);
...
{
    printf("metisMatchingRulesTable_GetUnion_2Table\n");//DEBUG
...
{
    printf("metisMatchingRulesTable_GetUnion_3Table\n");//DEBUG
