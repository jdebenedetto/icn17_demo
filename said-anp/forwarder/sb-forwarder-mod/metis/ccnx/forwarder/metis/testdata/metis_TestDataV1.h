...
__attribute__((unused))
static uint8_t metisTestDataV1_Interest_NoFlags[] = {
    0x01, 0x00, 0x00, 100, // ver = 1, type = interest, length = 100
    0x20, 0x00, 0x00, 14,  // HopLimit = 32, reserved = 0, flags = 0x00, header length = 14
    // ------------------------
    0x00, 0x01, 0x00, 2,   // Interest Lifetime (2 bytes)
    0xEA, 0xEB,
    // ------------------------
...
__attribute__((unused))
static uint8_t metisTestDataV1_Interest_ANP[] = {
    0x01, 0x00, 0x00, 65,  // ver = 1, type = interest, length = 65
    0x20, 0x00, 0x01, 24,  // HopLimit = 32, reserved = 0, flags = ANP, header length = 24
    // ------------------------
    0x00, 0x03, 0x00, 12,  // Interest Fragment
    0x01, 0x02, 0x03, 0x04,
    0x05, 0x06, 0x07, 0x08, // fragment 0x0102030405060708
