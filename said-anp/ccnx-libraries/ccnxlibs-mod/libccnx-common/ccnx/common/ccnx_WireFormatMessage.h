...
/**
 * Write the flags value to a messages attached wire format io vectors or buffers
 *
 * @param [in] message
 ...
 * @endcode
 */
bool ccnxWireFormatMessage_SetFlags(CCNxWireFormatMessage *message, uint32_t flags);
