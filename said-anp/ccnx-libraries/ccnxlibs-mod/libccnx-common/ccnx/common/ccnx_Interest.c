                            ...
                            const uint32_t hopLimit)
{
    ...
    if (impl->create != NULL) {
        result = impl->create(name, interestLifetime, keyId, contentObjectHash, hopLimit, CCNxInterestDefault_Flags);
...
CCNxInterest *
ccnxInterest_CreateWithImplFlag(const CCNxInterestInterface *impl,
                            const CCNxName *name,
                            const uint32_t interestLifetime,
                            const PARCBuffer *keyId,
                            const PARCBuffer *contentObjectHash,
                            ...
                            const uint32_t flags)
{
    ...
    if (impl->create != NULL) {
        result = impl->create(name, interestLifetime, keyId, contentObjectHash, hopLimit, flags);
...
// bool
// ccnxInterest_SetFlag(CCNxInterest *interest, unsigned index)
// {
//     ccnxInterest_OptionalAssertValid(interest);
//     CCNxInterestInterface *impl = ccnxInterestInterface_GetInterface(interest);
...
//     if (impl->setFlag != NULL) {
//         result = impl->setFlag(interest, index);
//     } else {
//         trapNotImplemented("ccnxInterest_SetFlag");
//     }
//     return result;
// }

// int
// ccnxInterest_GetFlag(const CCNxTlvDictionary *interest, unsigned index)
// {
//     ccnxInterest_OptionalAssertValid(interest);
//     CCNxInterestInterface *impl = ccnxInterestInterface_GetInterface(interest);
...
//     if (impl->getFlag != NULL) {
//         result = impl->getFlag(interest, index);
//     } else {
//         trapNotImplemented("ccnxInterest_GetFlag");
//     }
//     return result;
// }

// bool
// ccnxInterest_ClearFlag(CCNxInterest *interest, unsigned index)
// {
//     ccnxInterest_OptionalAssertValid(interest);
//     CCNxInterestInterface *impl = ccnxInterestInterface_GetInterface(interest);
...
//     if (impl->clearFlag != NULL) {
//         result = impl->clearFlag(interest, index);
//     } else {
//         trapNotImplemented("ccnxInterest_ClearFlag");
//     }
//     return result;
// }
...
//     if (impl->resetFlags != NULL) {
//         result = impl->resetFlags(interest);
//     } else {
//         trapNotImplemented("ccnxInterest_ResetFlags");
//     }
//     return result;   
// }

bool
ccnxInterest_SetFlags(CCNxInterest *interest, uint32_t flags)
{
    ccnxInterest_OptionalAssertValid(interest);
    CCNxInterestInterface *impl = ccnxInterestInterface_GetInterface(interest);
    ...
    if (impl->setFlags != NULL) {
        result = impl->setFlags(interest, flags);
    } else {
        trapNotImplemented("ccnxInterest_SetFlags");
    }
    // Make sure any attached wire format buffers are in sync with the dictionary
    ccnxWireFormatMessage_SetFlags(interest, flags);
    return result;
}

uint32_t
ccnxInterest_GetFlags(const CCNxTlvDictionary *interest)
{
    ccnxInterest_OptionalAssertValid(interest);
    CCNxInterestInterface *impl = ccnxInterestInterface_GetInterface(interest);
    ...
    if (impl->getFlags != NULL) {
        result = impl->getFlags(interest);
    } else {
        trapNotImplemented("ccnxInterest_GetFlags");
    }
    return result;
}
