...
// static bool
// _ccnxInterestFacadeV1_SetFlag(CCNxTlvDictionary *interestDictionary, unsigned index)
// {
//     _assertInvariants(interestDictionary);
//     trapNotImplemented("_ccnxInterestFacadeV1_SetFlag");
//     return false;
// }

// static bool
// _ccnxInterestFacadeV1_ClearFlag(CCNxTlvDictionary *interestDictionary, unsigned index)
// {
//     _assertInvariants(interestDictionary);
//     trapNotImplemented("_ccnxInterestFacadeV1_ClearFlag");
//     return false;
// }

// static bool
// _ccnxInterestFacadeV1_ResetFlags(CCNxTlvDictionary *interestDictionary)
// {
//     _assertInvariants(interestDictionary);
//     trapNotImplemented("_ccnxInterestFacadeV1_ResetFlags");
//     return false;
// }

static bool
_ccnxInterestFacadeV1_SetFlags(CCNxTlvDictionary *interestDictionary, uint32_t flags)
{
    _assertInvariants(interestDictionary);
    return ccnxTlvDictionary_PutInteger(interestDictionary, CCNxCodecSchemaV1TlvDictionary_MessageFastArray_FLAGS, flags);
}
...
static int
_ccnxInterestFacadeV1_GetFlag(CCNxTlvDictionary *interestDictionary, unsigned index)
{
    _assertInvariants(interestDictionary);
    trapNotImplemented("_ccnxInterestFacadeV1_GetFlag");
    return 0;
}

static uint32_t
_ccnxInterestFacadeV1_GetFlags(const CCNxTlvDictionary *interestDictionary)
{
    _assertInvariants(interestDictionary);
    return _fetchUint32(interestDictionary, CCNxCodecSchemaV1TlvDictionary_MessageFastArray_FLAGS, CCNxInterestDefault_Flags);
}
...
_ccnxInterestFacadeV1_Create(const CCNxName   *name,                       // required
                             ...
                             const uint32_t flags)                         // may be DefaultFlags
{
    ...
    if (dictionary) {
        ...
        if (flags != CCNxInterestDefault_Flags) {
            _ccnxInterestFacadeV1_SetFlags(dictionary, flags);
        }
    } else {
...
CCNxInterestInterface CCNxInterestFacadeV1_Implementation = {
    ...
    // .getFlag                         = &_ccnxInterestFacadeV1_GetFlag,
    // .setFlag                         = &_ccnxInterestFacadeV1_SetFlag,
    // .clearFlag                       = &_ccnxInterestFacadeV1_ClearFlag,
    // .resetFlags                      = &_ccnxInterestFacadeV1_ResetFlags,

    .getFlags                        = &_ccnxInterestFacadeV1_GetFlags,
    .setFlags                        = &_ccnxInterestFacadeV1_SetFlags,
