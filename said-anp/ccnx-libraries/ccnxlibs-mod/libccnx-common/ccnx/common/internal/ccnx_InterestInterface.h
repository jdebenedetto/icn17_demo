...
typedef struct ccnx_interest_interface {
    ...
    // bool (*setFlag)(CCNxTlvDictionary *dict, unsigned index);

    /** @see ccnxInterest_GetFlag */
    // int (*getFlag)(const CCNxTlvDictionary *dict, unsigned index);

    /** @see ccnxInterest_ClearFlag */
    // bool (*clearFlag)(const CCNxTlvDictionary *dict, unsigned index);

    /** @see ccnxInterest_ResetFlags */
    // bool (*resetFlags)(const CCNxTlvDictionary *dict);

    /** @see ccnxInterest_SetFlags */
    bool (*setFlags)(CCNxTlvDictionary *dict, uint32_t flags);

    /** @see ccnxInterest_GetFlags */
    uint32_t (*getFlags)(const CCNxTlvDictionary *dict);
