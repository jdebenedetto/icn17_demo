...
LONGBOW_TEST_FIXTURE(SchemaV1)
{
    ...
    LONGBOW_RUN_TEST_CASE(SchemaV1, ccnxWireFormatFacadeV1_SetFlags);
...
LONGBOW_TEST_CASE(SchemaV1, ccnxWireFormatFacadeV1_SetFlags)
{
    uint8_t *data = parcMemory_Allocate(64);
    memset(data, 0, 64);
    ...
    _ccnxWireFormatFacadeV1_SetFlags(packet, 15);
